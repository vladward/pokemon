function CornerScrew({ className }: { className: string }) {
  return (
    ...
    >
      <svg className="absolute inset-0" width="10" height="10" viewBox="0 0 10 10" aria-hidden>
        <line x1="5" y1="2" x2="5" y2="8" stroke="rgba(0,0,0,0.5)" strokeWidth="1" strokeLinecap="round" />
        <line x1="2" y1="5" x2="8" y2="5" stroke="rgba(0,0,0,0.5)" strokeWidth="1" strokeLinecap="round" />
      </svg>
    </div>
  );
}
